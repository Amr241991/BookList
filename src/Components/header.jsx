    ...
    <div className='bg-slate-200'>
      <div className='flex justify-between items-center px-4 sm:px-8 lg:px-16 xl:px-32 mx-auto p-3'>
        ...
        <div className='hidden sm:flex justify-center space-x-4'>
          <Link className='text-gray-800 hover:text-gray-600' to='/'>Ana Sayfa</Link>
          <Link className='text-gray-800 hover:text-gray-600' to='/about'>Hakkımızda</Link>
          <Link className='text-gray-800 hover:text-gray-600' to='/contact'>İletişim</Link>
        </div>
              ...
              <div className='relative'>
                ...
                <div className=''>
                  ...
                  <ul className={`absolute p-1 flex flex-col bg-white shadow-md rounded-lg -right-px mt-3 z-1 ${linksOpen ? 'block' : 'hidden'} `}>
                    <Link className='text-gray-800  hover:text-gray-600 p-2 hover:bg-gray-200- sm:hidden' to='/about'>Hakkımızda</Link>
                    <Link className='text-gray-800 hover:text-gray-600 p-2 hover:bg-gray-200 sm:hidden' to='/'>Ana Sayfa</Link>
                    <Link className='text-gray-800 hover:text-gray-600 p-2 hover:bg-gray-200 sm:hidden' to='/contact'>İletişim</Link>
